...
const toshow = document.getElementById('toshow'); // 按鈕產生圖
const show = document.getElementById('show'); 	// 顯示圖
const clear = document.getElementById('clear'); // 按鈕清除
let drawing = false;	//判斷是否正在繪圖
const queue = [];		//佇列結構依序產生筆畫
